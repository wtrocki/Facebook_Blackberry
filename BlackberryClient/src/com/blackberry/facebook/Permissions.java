...
public class Permissions {
	...
	public static final String[] USER_DATA_PERMISSIONS = new String[] {
			...
			USER_WORK_HISTORY, EMAIL, READ_FRIENDLISTS, READ_INSIGHTS,
			READ_MAILBOX, READ_REQUESTS, READ_STREAM, XMPP_LOGIN,
			ADS_MANAGEMENT, USER_CHECKINS };
	public static final String[] FRIENDS_DATA_PERMISSIONS = new String[] {
			...
			FRIENDS_WORK_HISTORY, MANAGE_FRIENDLISTS, FRIENDS_CHECKINS };
	// public static final String[] PUBLISHING_PERMISSIONS = new String[] {
	...
	// USER_RELIGION_POLITICS, USER_STATUS, USER_VIDEOS, USER_WEBSITE,
	// USER_WORK_HISTORY, EMAIL, READ_FRIENDLISTS, READ_INSIGHTS,
	// READ_MAILBOX, READ_REQUESTS, READ_STREAM, XMPP_LOGIN, ADS_MANAGEMENT,
	// USER_CHECKINS, FRIENDS_ABOUT_ME, FRIENDS_ACTIVITIES,
	// FRIENDS_BIRTHDAY, FRIENDS_EDUCATION_HISTORY, FRIENDS_EVENTS,
	...
	public static final String[] ALL_PERMISSIONS = new String[] {
			...
			USER_WORK_HISTORY, EMAIL, READ_FRIENDLISTS, READ_INSIGHTS,
			READ_MAILBOX, READ_REQUESTS, READ_STREAM, XMPP_LOGIN,
			ADS_MANAGEMENT, USER_CHECKINS, FRIENDS_ABOUT_ME,
			FRIENDS_ACTIVITIES, FRIENDS_BIRTHDAY, FRIENDS_EDUCATION_HISTORY,
			FRIENDS_EVENTS, FRIENDS_GROUPS, FRIENDS_HOMETOWN,
			...
			FRIENDS_WEBSITE, FRIENDS_WORK_HISTORY, MANAGE_FRIENDLISTS,
			FRIENDS_CHECKINS, PUBLISH_STREAM, CREATE_EVENT, RSVP_EVENT,
			OFFLINE_ACCESS, PUBLISH_CHECKINS, MANAGE_PAGES };
